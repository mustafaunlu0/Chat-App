...
import com.mustafaunlu.chatapp.adapters.RecentConversationsAdapter;
import com.mustafaunlu.chatapp.databinding.ActivityMainBinding;
...
public class MainActivity extends BaseActivity implements ConversionListener {
    ...
    private void setListeners() {
        binding.signOutImage.setOnClickListener(e->signOut());
        binding.newChatFab.setOnClickListener(v-> startActivity(new Intent(getApplicationContext(),UsersActivity.class)));
    }
            ...
            for(DocumentChange documentChange : value.getDocumentChanges()){
                if(documentChange.getType()==DocumentChange.Type.ADDED){
                    ...
                    if(preferenceManager.getString(Constants.KEY_USER_ID).equals(senderId)){
                        ...
                        chatMessage.conversionId=documentChange.getDocument().getString(Constants.KEY_SENDERID);
    ...
    private void signOut(){
        ...
        FirebaseFirestore dataabase=FirebaseFirestore.getInstance();
        DocumentReference document=dataabase.collection(Constants.KEY_COLLECTION_USERS).document(
                preferenceManager.getString(Constants.KEY_USER_ID)
        );
        HashMap<String,Object> updates=new HashMap<>();
        updates.put(Constants.KEY_FCM_TOKEN,FieldValue.delete());
        document.update(updates).addOnSuccessListener(unused ->{
